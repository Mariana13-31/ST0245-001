...
public abstract class Digraph {
	...
	*/
	public abstract void addArc(int source, int destination, int weight) throws Exception;
	...
	*/
	public abstract ArrayList<Integer> getSuccessors(int vertex) throws Exception;
	...
	*/	
	public abstract int getWeight(int source, int destination) throws Exception;
